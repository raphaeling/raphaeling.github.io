const experienceItems = [
  {
    workplace: 'Disney Streaming',
    title: 'Software Engineer Intern',
    startDate: '06/22',
    endDate: '11/22',
    description: 'Played a pivotal role in the Experience Engineering team in unifying & maintaining the browsable viewer surface area and content management platforms & APIs delivered for Hulu, Disney+ & Star+ tenants in an Agile/Scrum environment.',
    skills: ['Java', 'Kotlin', 'Spring Boot', 'JavaScript', 'React.js', 'Terraform', 'AWS'],
  },
  {
    workplace: 'Tesla, Inc.',
    title: 'Software Engineer Intern',
